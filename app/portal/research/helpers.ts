...
export async function getLLMResponse({ system = 'You are a helpful assistant.', user = '', temperature = 1, model = 'gpt-4o' }): Promise<{ text: string | null, usage: OpenAI.Completions.CompletionUsage | undefined }> {
...
async function synthesizeReport(topic: string, searchContents: SearchResult<ContentsOptions>[], contentSlice = 750) {
