        ...
        <Box>
            ...
            <BubbleMenu editor={editor}>
                <Button.Group>
                    ...
                    <Button variant="default" onClick={() => editor.chain().focus().toggleHeading({ level: 1 })} size='compact-sm'>H1</Button>
                    <Button variant="default" size='compact-sm'>H2</Button>
                    <Button variant="default" size='compact-sm'>H3</Button>
                </Button.Group>
            </BubbleMenu>
