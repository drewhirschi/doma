...
const images = [
  {
    url: "https://images.unsplash.com/photo-1592323818181-f9b967ff537c",
    alt: "Best forests to visit in North America",
    category: "nature",
  },
  {
    url: "https://images.unsplash.com/photo-1559494007-9f5847c49d94?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=800&q=80",
...
export default async function Page({
  ...
  try {
    ...
    return (
      <Group mih={"100vh"} align="flex-start" wrap="nowrap">
        <Box flex={3} mih={"inherit"} bg={"gray.1"} maw={"280px"} p="md">
          <ReportEditorNavbar />
        </Box>
